...
def db_connect():
    try:
        ...
        db_connection = sql.connect(host='localhost', database='database_name', user='root', password='Password')
        if db_connection:
...
def query_engine(query):
    ...
    def db_selected():
        ...
        db_connection2 = sql.connect(host='localhost', database='pradeep', user='root', password='Pradeep@1103') 
        if db_connection2:
